...
print("Start Running")
path <- "C:/Users/Rocky/Desktop/BTI_Git/BTI_Intern/Wild_vs_Cultivated/Testing/Enrichment/Z_Results/L_C_Results.txt"
# Read the data
...
pdf("C:/Users/Rocky/Desktop/BTI_Git/BTI_Intern/Wild_vs_Cultivated/Testing/Enrichment/Z_Results/L_C_Results.pdf", height = 3, width = 8.5)
print(combined_plot)
dev.off()
